  ...
  return (
    <div className="max-w-md mx-auto h-screen bg-[var(--gn-bg)] text-[var(--gn-base)] relative overflow-hidden flex flex-col items-center justify-center shadow-2xl p-6 text-center">
      ...
      <div className="relative mb-6">
        ...
        <div className="absolute bottom-1 right-1 bg-[var(--gn-primary)] text-white rounded-full p-1.5 shadow-lg border-2 border-[var(--gn-bg)] z-20">
      ...
      <div className="space-y-2 max-w-[280px]">
        <h1 className="text-4xl font-black text-transparent tracking-wide bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 bg-clip-text">
          ¡Gracias!
        </h1>
        <p className="text-2xl font-bold text-[var(--gn-primary-dk)] drop-shadow-[0_0_6px_rgba(16,185,129,0.2)]">
          +50 GPts sumados
        </p>
